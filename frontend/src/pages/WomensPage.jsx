...
const WomensPage = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            setLoading(true);
            try {
                const data = await productService.getProducts({ category: 'women' });
                setProducts(data);
            } catch (error) {
                console.error(error);
            } finally {
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="pb-24">
            <header className="bg-white/3 pt-24 md:pt-32 pb-8 md:pb-16 overflow-hidden relative">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-6xl font-display font-bold capitalize drop-shadow-lg">
                        Women's <span className="text-primary">Wear</span>
                    </h1>
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="w-full lg:w-72 space-y-12">
                                ...
                                <div className="block lg:hidden relative group">
                                    <select 
                                        ...
                                        onChange={(e) => {
                                            ...
                                            setType(t);
                                            navigate(t === 'All' ? '/womens' : `/womens/${t.toLowerCase()}`);
                                        }}
                                    ...
                                    >
                                        {['All', 'Blouse', 'Kurti', 'Lehenga', 'Gown', 'Dress', 'Top', 'Skirt'].map(t => (
                        ...
                        <div className="p-6 bg-primary/5 border border-primary/20 rounded-2xl space-y-4">
                            ...
                            <p className="text-xs text-slate-400 leading-relaxed">Book a consultation for perfectly fitted bespoke dresses.</p>
                    ...
                    <div className="flex-grow space-y-8">
                        ...
                        {filteredProducts.length > 0 ? (
                            ...
                            <div className="text-center py-20 space-y-4">
                                <p className="text-slate-400 text-xl font-display">No women's wear found for these filters.</p>
            ...
            <ConsultationModal isOpen={isConsultationOpen} onClose={() => setIsConsultationOpen(false)} type="fitting" category="women" />
        </motion.div>
    );
};
